 ...
 */
@Messages({
   "MSG_NoCommand=No Command defined for this file (MIME Type: {0})",
   "MSG_InvalidFile=Invalid file: {0}", "MSG_CommandSuccess=Command ''{0}'' executed successfully: {1}",
   "MSG_CommandFailed=Command ''{0}'' failed: {1} [Reason: {2}]",
   "MSG_CommandFailed_html=<html>Command failed:<br><code>{0}</code><br>Reason: {1}</html>"
})

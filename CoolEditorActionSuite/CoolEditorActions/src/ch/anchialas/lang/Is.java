 ...
 *
 * $Id: Is.java 47 2013-07-17 21:13:41Z Anchialas $
 */
...
public final class Is {
   ...
   /**
    * Compares the two specified
    * <code>float</code> values. This call is equal to:
    * <pre>
    *    Float.compare(a,b) == 0;
    * </pre>
    *
   ...
   /**
    * Compares the two specified
    * <code>double</code> values. This call is equal to:
    * <pre>
   ...
   /**
    * Compares the two Objects for equality (Objects can be possibly
    * <code>null</code>).
    * <p>
